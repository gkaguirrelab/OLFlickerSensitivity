function [keyEvents, t, tmp] = OLFlickerStartsStops(ol, starts, stops, frameDurationSecs, numIterations, checkKB)
...
yHint = sin(880*2*pi*linspace(0, 3*durSecs, 3*durSecs*fs));
