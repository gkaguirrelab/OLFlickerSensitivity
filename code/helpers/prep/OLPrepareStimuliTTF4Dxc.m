...
for o = theAges;
    fprintf('Age: %g\n', o);
    % L+M CRF
    OLMakeModulations(['Modulation-LMDirected-45sWindowedFrequencyCRFModulation.cfg'], o);
    
    % Melanopsin 20%
    OLMakeModulations(['Modulation-MelanopsinDirected-45sWindowedFrequencyModulation.cfg'], o);
    
    % MelanopsinLegacy 20% (40% of 50%)
    OLMakeModulations(['Modulation-MelanopsinDirectedLegacy-45sWindowedFrequencyScaledContrastModulation.cfg'], o);
end
