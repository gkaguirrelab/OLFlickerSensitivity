...
theCalType = 'BoxALongCableBEyePiece2';
OLMakeModulations('Modulation-Background-60s.cfg', o, theCalType, nullingID);
OLMakeModulations('Modulation-MelanopsinDirectedNulled-24sSqWave.cfg', o, theCalType, nullingID)
OLMakeModulations('Modulation-LMSDirectedNulled-24sSqWave.cfg', o, theCalType, nullingID)

%% fMRI experiments
% Make the modulations
OLMakeModulations('Modulation-Background-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID) % Background
OLMakeModulations('Modulation-MelanopsinDirectedUnnulled-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID); % Not nulled
OLMakeModulations('Modulation-MelanopsinDirectedNulled-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID) % Nulled
OLMakeModulations('Modulation-NulledResidualSplatter-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID) % Residual
