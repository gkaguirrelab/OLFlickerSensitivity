...
nullingID = 'M081915M'; o = 29;
theCalType = 'BoxALongCableBEyePiece2';
OLMakeModulations('Modulation-MelanopsinDirectedLegacyNulled-45sWindowedFrequencyModulation.cfg', o, theCalType, nullingID) % Nulled Melanopsin
OLMakeModulations('Modulation-LMSDirectedNulled-45sWindowedFrequencyModulation.cfg', o, theCalType, nullingID); % Nulled LMS
OLMakeModulations('Modulation-LightFlux-45sWindowedFrequencyModulation.cfg', o, theCalType, nullingID); % Light flux
OLMakeModulations('Modulation-Background-60s.cfg', o, theCalType, nullingID) % Background 60s
