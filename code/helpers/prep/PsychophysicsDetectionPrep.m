...
% OLMakeModulations('Modulation-Background-60s.cfg', o, nullingID);
% OLMakeModulations('Modulation-MelanopsinDirected-45sWindowedFrequencyModulation.cfg', o, nullingID)
% OLMakeModulations('Modulation-LMSDirected-45sWindowedFrequencyModulation.cfg', o, nullingID)