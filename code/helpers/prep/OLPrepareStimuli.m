...
OLMakeModulations('Modulation-MelanopsinDirectedRobust-50sContrastModulation.cfg', 26);

%% Contrast modulation, 50 s
theObserverAges = [25 26];
for observerAgeInYears = theObserverAges
    OLMakeModulations('Modulation-Isochromatic-50sContrastModulation.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-LMDirected-50sContrastModulation.cfg', observerAgeInYears);
    %OLMakeModulations('Modulation-MelanopsinDirected-50sContrastModulation.cfg', observerAgeInYears);
    %OLMakeModulations('Modulation-SDirected-50sContrastModulation.cfg', observerAgeInYears);
    %OLMakeModulations('Modulation-Background-300sContrastModulation.cfg', observerAgeInYears);
end
...
for observerAgeInYears = theObserverAges
    OLMakeModulations('Modulation-Isochromatic-12sFlicker.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-LMDirected-12sFlicker.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-MelanopsinDirected-12sFlicker.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-MelanopsinDirectedRobust-12sFlicker.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-SDirected-12sFlicker.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-LMinusMDirected-12sFlicker.cfg', observerAgeInYears);
end
...
for observerAgeInYears = theObserverAges
    OLMakeModulations('Modulation-Background-300sContrastModulation.cfg', observerAgeInYears);
    OLMakeModulations('Modulation-MelanopsinDirected-50sScaledContrastModulation.cfg', observerAgeInYears);
    
    
    %OLMakeModulations('Modulation-RodDirectedHigh-50sContrastModulation.cfg', observerAgeInYears);
    %OLMakeModulations('Modulation-RodDirectedLow-50sContrastModulation.cfg', observerAgeInYears);
...
OLMakeModulations('Modulation-SDirected-45sFrequencyModulation.cfg', observerAge);
OLMakeModulations('Modulation-RodDirected-45sFrequencyModulation.cfg', observerAge);
OLMakeModulations('Modulation-MelanopsinDirected-45sFrequencyModulation.cfg', observerAge);
OLMakeModulations('Modulation-OmniSilent-45sFrequencyModulation.cfg', observerAge);
OLMakeModulations('Modulation-Background-300s.cfg', observerAge);
