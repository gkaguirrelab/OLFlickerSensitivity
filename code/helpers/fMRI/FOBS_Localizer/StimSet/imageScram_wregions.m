function imageScram_wregions(folder1,folder2,n,num_regions,neib,fmt,gridScram,fcolor,gs,sufs,folder3,fftstd)
% IMAGESCRAM.M
...
%  -1: scramgling is completely random within each of num_regions
