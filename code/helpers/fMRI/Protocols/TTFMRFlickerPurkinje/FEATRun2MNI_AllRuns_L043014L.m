...
% Combine
INPUT_FILE_PREFIX = 'stats'; SUBJECT_FSL = 'L043014L';
FEAT_DIRS = {'TTFMRFlickerPurkinje_LMPenumbraDirected_A.feat'}; nRuns = length(FEAT_DIRS);
COPES = {'cope1' 'cope2' 'cope3' 'cope4' 'cope5' 'cope6'}; nCopes = length(COPES);
VARCOPES = {'varcope1' 'varcope2' 'varcope3' 'varcope4' 'varcope5' 'varcope6'};
