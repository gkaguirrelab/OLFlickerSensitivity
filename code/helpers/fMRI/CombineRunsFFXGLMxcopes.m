function [lhGlmDirs rhGlmDirs] = CombineRunsFFXGLMxcopes(BASE_PATH, FWHM, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, FEAT_DIRS, nRuns, COPES, VARCOPES, nCopes, SUBJECTS_PER_FEAT)
...
lhGlmCount = 1;
rhGlmCount = 1;
for i = 1:nCopes    % Copes
    % Left hemisphere
    hemi = 'lh';
    outFile = fullfile(BASE_PATH, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, ['cope_xcope.' hemi '.xrun_osgm.diffeo.sym.mgh']);
    theInputs = [];
    theSubjects = [];
    ...
    % Left hemisphere
    hemi = 'lh';
    outFile = fullfile(BASE_PATH, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, ['varcope_xcope.' hemi '.xrun_osgm.diffeo.sym.mgh']);
    theInputs = [];
    theSubjects = [];
    for j = 1:nRuns % Assemble the inputs
        for i = 1:nCopes    % Copes
    ...
    % Left hemisphere
    hemi = 'lh';
    inputXRun = fullfile(BASE_PATH, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, ['cope_xcope.' hemi '.xrun_osgm.diffeo.sym.mgh']);
    inputXRunVar = fullfile(BASE_PATH, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, ['varcope_xcope.' hemi '.xrun_osgm.diffeo.sym.mgh']);
    glmDir = fullfile(BASE_PATH, SUBJECT_FSL, BOLD_DIR, COMBINED_DIR, INPUT_FILE_PREFIX, ['cope_xcope.' hemi '.osgm.ffx']);
