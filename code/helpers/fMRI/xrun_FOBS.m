theSubjects = {'G120413A', 'M120413S' 'M121113M'};
...
for s = 1:length(theSubjects)
    ...
    glmDirs = CombineRunsFFXGLMxhemis_bk(BASE_PATH, FWHM, SUBJECT_FSL, BOLD_DIR, 'FOBSLocalizer_xrun', ...
    ...
    glmDirs = CombineRunsFFXGLMxhemis_bk(BASE_PATH, FWHM, SUBJECT_FSL, BOLD_DIR, 'MTLocalizer_xrun', ...
        INPUT_FILE_PREFIX, FEAT_DIRS, nRuns, COPES, VARCOPES, nCopes);
