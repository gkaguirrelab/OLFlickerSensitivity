...
% Background
backgroundRGB = [0 0 0]; % Half-on
annulusRGB = [0 0 0]; % Full-on

% The 'inner circle', i.e. the hole
innerCircleDiameter = 74;%100; % px
innerCircleRGB = backgroundRGB; % Assume that it's the same as background, but it can be changed.

% The 'outer circle'
outerCircleDiameter = 237;%200; % px
outerCircleRGB = annulusRGB;

% Fixation cross
fixationCrossDiameter = 30;
