function [] = PIPRMaxPulse_PrepOOC_function(theCalType, maxBluePIPRIntensity)
...
params.fwhmNm = 25;
params.filteredRetinalIrradianceLogPhotons = maxBluePIPRIntensity; % In log quanta/cm2/sec
