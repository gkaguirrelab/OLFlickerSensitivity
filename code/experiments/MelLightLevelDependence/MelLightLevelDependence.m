%% General procedure
theCalibrationTypes = {'BoxAShortCableCEyePiece2' ...
    'BoxAShortCableCEyePiece2_ND05' ...
    'BoxAShortCableCEyePiece2_ND10' ...
    'BoxAShortCableCEyePiece2_ND15' ...
    'BoxAShortCableCEyePiece2_ND20'};

for c = 1:length(theCalibrationTypes)
    %% Standard parameters
    params.experiment = 'OLFlickerSensitivity';
    params.experimentSuffix = 'MelLightLevelDependence';
    theCalType = 'BoxAShortCableCEyePiece2';
