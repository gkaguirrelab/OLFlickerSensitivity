function MelLightDependence_DoNullingAndMakeModulation(nullingID, observerAgeInYrs, theBaseCalTypeShort, modType, nullingFrequencyHz, keyAssignment)
...
% Select the protocol
availableProtocols = {'NullingPopulationDataFork2', 'NullingPopulationData18To24'};
keepPrompting = true;
while keepPrompting
